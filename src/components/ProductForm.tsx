      ...
      >
        <div className="modal-heading">
          <div>
            ...
            <h2 id="product-form-title">{product ? "Edit product" : "Add a product"}</h2>
            <p>Keep the details clear and easy to find.</p>
          </div>
          <button className="icon-button" aria-label="Close form" onClick={onClose}>
            <X size={20} />
          </button>
        </div>
        <form onSubmit={submit} className="product-form">
          <div className="field">
            ...
            <input
              ...
              maxLength={100}
              required
              placeholder="e.g. Everyday headphones"
            />
          </div>
          <div className="field">
